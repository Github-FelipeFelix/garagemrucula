// Icone do WhatsApp (o lucide-react nao inclui marcas). Herda a cor via currentColor.
...
// Icone do Instagram (outline, no estilo dos icones lucide). O lucide removeu marcas.
